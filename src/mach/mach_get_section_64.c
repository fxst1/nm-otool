...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   mach_get_section_64.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: fxst1 <fxst1@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/12 17:00:25 by fxst1             #+#    #+#             */
/*   Updated: 2018/04/14 16:37:23 by fjacquem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <binary.h>

static int	get_section2(t_segment64_command *cmd, char *sectname,
								t_section_info *sect)
{
	size_t	i;
	size_t	n;
...
void		mach_get_section_64(t_mach64 data, char *segname, char *sectname,
								t_section_info *sect)
{
	size_t				i;
	size_t				n;
